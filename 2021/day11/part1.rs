...
// Solution to AoC 2021 Day 11 Part 1
...
// run through a step, returning the number of flashed octopi
fn step(octopi: &mut [[u8; 10]; 10]) -> u32 {
    ...
    have_flashed.into_iter().flatten().map(u32::from).sum()
}
