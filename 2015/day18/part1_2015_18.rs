...
// Solution to AoC 2015 Day 18 Part 1

// This is literally just Conway's Game of Life.
// I've implemented Conway's Game of Life before, but not for a good few years, and not in Rust.
