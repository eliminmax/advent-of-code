...
// Solution to AoC 2017 Day 11 Part 2
...
// saving on redundant math, I used that for part 1. The "saving on redundant math" doesn't really
// apply to part 2, but I don't mind.
//
...
fn main() {
    ...
    input
        ...
        .for_each(|d| {
            position += d;
            furthest = furthest.max(position.distance_from_origin());
        });
    println!("{furthest}");
}
